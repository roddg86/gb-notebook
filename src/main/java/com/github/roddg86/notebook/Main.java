...
import com.github.roddg86.notebook.util.log.impl.FileLog;
...
public class Main {
    public static void main(String[] args) {
        ...
        UserControllerDecorator controller = new UserControllerDecorator(repository, new ConsoleLog(), new FileLog());
